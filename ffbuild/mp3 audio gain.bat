...
@REM *--------------------------------------------------------------------------------------------------------*
@REM -vn <— Отключите видео, чтобы убедиться, что видео (включая изображение обложки альбома) не включено, если источником может быть видеофайл.
...
set b="Result\%%~na.mp3"
set c=ffmpeg
set f=-filter:a "volume=%volume%" -vn -ar 44100 -ac 2 -b:a 192k -map_metadata 0 -id3v2_version 3
