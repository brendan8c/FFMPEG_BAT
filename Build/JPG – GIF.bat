@REM In the Your_files folder put png files with a similar naming file-001.jpg file-002.jpg file-003.jpg...
@REM fps=10 frames per second
@REM *--------------------------------------------------------------------------------------------------------*
@REM В папку Your_files положите png файлы с подобным именованием file-001.jpg file-002.jpg file-003.jpg...
